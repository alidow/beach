...
fn test_cursor_movement() {
    ...
    
    {
        ...
        for (i, ch) in expected.chars().enumerate() {
            ...
            assert_eq!(cell.char, ch, "Character mismatch at row 4, column {}", 9 + i);
        }
    }
}
    ...
    
    {
        ...
        for row in 0..24 {
            for col in 0..80 {
                ...
                assert_eq!(cell.char, ' ', "Cell at ({}, {}) should be space after clear", row, col);
            }
        }
    }
}
...
fn test_emoji_handling() {
    ...
    
    {
        ...
        for (i, ch) in expected.chars().enumerate() {
            ...
            assert_eq!(cell.char, ch, "Character mismatch at position {}", space_col + 1 + i as u16);
        }
    }
}
...
fn test_memory_limit() {
    ...
    assert!(current.is_ok(), "Should be able to get current state after memory limit");
}